...
<!-- <table class="ui table" id="ticketTable" width="800" border="0" cellspacing="0" cellpadding="0"> -->
<!-- <table class="ui table" id="ticketTable" width="800" border="0" cellspacing="0" cellpadding="0"> -->
<!-- <table class="ui table" id="ticketTable" width="800" border="0" cellspacing="0" cellpadding="0">
<table class="ui table" id="ticketTable" width="800" border="0" cellspacing="0" cellpadding="0">
<table class="ui table" id="ticketTable" width="800" border="0" cellspacing="0" cellpadding="0">
...
<!-- <table class="ui table" id="ticketTable" width="800" border="0" cellspacing="0" cellpadding="0"> -->
<!-- <table class="ui table" id="ticketTable" width="800" border="0" cellspacing="0" cellpadding="0"> -->
<table class="ui table" width="800" border="0" cellspacing="0" cellpadding="0">
     ...
     if ($tickets->exists(true)) {
         foreach ($tickets as $T) {
            ...
            <tr id="<?php echo $T['ticket_id']; ?>">
                ...
                <td><span class="truncate"><?php echo $dept; ?></span></td>                <td><?php echo $status; ?></td>
